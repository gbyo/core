...
# The only relay error that changes subscription lifecycle.
ERROR_INVALID_TOKEN = "InvalidToken"

# Opaque RemoteMedia context persisted inside a generic push subscription.
CONTEXT_GENERATION = ATTR_GENERATION
CONTEXT_GENERATION_SEQUENCE = ATTR_GENERATION_SEQUENCE
CONTEXT_SERVER_ID = ATTR_SERVER_ID_KEY
